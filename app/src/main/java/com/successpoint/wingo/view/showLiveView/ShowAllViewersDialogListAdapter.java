...
public class ShowAllViewersDialogListAdapter extends RecyclerView.Adapter<ShowAllViewersDialogListAdapter.ViewHolder> {

    private static final String TAG = ShowAllViewersDialogListAdapter.class.getSimpleName();
    private Context mContext;
    private List<UserModelObject> mList;
    private OnItemClickListener mListener;

    public ShowAllViewersDialogListAdapter(Context context, List<UserModelObject> list, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.viewr_list_item, parent, false);
